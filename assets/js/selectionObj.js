...
const langString = {
    "zh": { "Sp": '　',
            ...
            "Effect": '效果',
            "Pendulum": '靈擺',
            "subType": {"Fusion": "融合", "Ritual": "儀式",
                        "Synchro": "同步", "Xyz": "超量", "Link": "連結"},
            "effType": ["卡通","靈魂","聯合","二重","反轉","協調"],
            "thrType": ["惡魔族","不死族","海龍族","雷族","岩石族","機械族","恐龍族","獸族","昆蟲族","魚族","植物族","獸戰士族","戰士族","鳥獸族","天使族","龍族","爬蟲類族","水族","炎族","魔法師族","幻龍族","網域族","超能族","幻神獸族","創造神族"],
            "Spell": "魔法卡",
            "Trap": "陷阱卡",
            "Attr": "jp",
            "Default": {
                ...
                "size": 20, "pSize": 22,
                "type": "monster", "subType": "Normal",
                "attr": "LIGHT", "effType": "Normal", "thrType": "15",
    ...
    "jp": { "Sp": '　',
            ...
            "Pendulum": 'ペンデュラム',
            "subType": {"Fusion": "融合", "Ritual": "儀式",
                        "Synchro": "シンクロ", "Xyz": "エクシーズ", "Link": "リンク"},
            "effType": ["トゥーン","スピリット","ユニオン","デュアル","リバース","チューナー"],
            "thrType": ["悪魔族","アンデット族","海竜族","雷族","岩石族","機械族","恐竜族","獣族","昆虫族","魚族","植物族","獣戦士族","戦士族","鳥獣族","天使族","ドラゴン族","爬虫類族","水族","炎族","魔法使い族","幻竜族","サイバース族","サイキック族","幻神獣族","創造神族"],
            "Spell": "魔法カード",
            "Trap": "罠カード",
            "Attr": "jp",
            "Default": {
    ...
    "en": { "Sp": '     ',
            ...
            "Effect": 'Effect',
            "Pendulum": 'Pendulum',
            "subType": {"Fusion": "Fusion", "Ritual": "Ritual",
                        "Synchro": "Synchro", "Xyz": "Xyz", "Link": "Link"},
            "effType": ["Toon","Spirit","Union","Gemini","Flip","Tuner"],
            "thrType": ["Fiend","Zombie","Sea Serpent","Thunder","Rock","Machine","Dinosaur","Beast","Insect","Fish","Plant","Beast-Warrior","Warrior","Winged Beast","Fairy","Dragon","Reptile","Aqua","Pyro","Spellcaster","Wyrm","Cyberse","Psychic","Divine-Beast","Creator God"],
            "Spell": "Spell Card",
            "Trap": "Trap Card",
            "Attr": "en",
            "Default": {
